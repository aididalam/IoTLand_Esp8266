...
void loop() {
   ...
   * 
   * ***********************************************************************
   * Card function need Two parameter
   * 
   * First parameter is Card Id. It is a Integer Type parameter. You can get Card Id from your IoTLand control Panel
   * Pass cardID as a Integer.
   * 
  ...
  Serial.println(iotland.card( cardID,String(data) )); // posting and Checking the retun value via serial monitor. You can also save this value in a bool variable
  delay(60000);
